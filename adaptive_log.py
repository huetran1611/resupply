...
for txt_file in txt_files:
    ...
    with open(txt_file, 'r') as file:
        ...
        # print(txt_file)
        log = os.path.basename(txt_file)+ f'{Data.number_of_cities}_{Data.drone_capacity}_{Data.number_of_drones}_log_new.log'
        ...
        for i in range(ITE):
            ...
            workbook.save(f"Result\excel_result\log_new_new_Smith_{Data.number_of_cities}_{Data.drone_capacity}_{Data.number_of_drones}.xlsx")
