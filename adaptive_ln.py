...
txt_files = glob.glob(os.path.join(folder_path, "C2*.dat"))
...
for txt_file in txt_files:
    ...
    with open(txt_file, 'r') as file:
        ...
        # print(txt_file)
        log = os.path.basename(txt_file)+ f'{Data.number_of_cities}_{Data.drone_capacity}_{Data.number_of_drones}_ln_testing.log'
        ...
        for i in range(ITE):
            ...
            workbook.save(f"Result\excel_result\ln_test_{Data.number_of_cities}_{Data.drone_capacity}_{Data.number_of_drones}.xlsx")
