...
def Tabu_search(init_solution, tabu_tenure, CC, first_time, Data1, index_consider_elite_set):
    ...
    SEGMENT = 5
    END_SEGMENT =  int(Data.number_of_cities/math.log(Data.number_of_cities))
...
folder_path = "test_data\\data_demand_random\\50\\"
...
for txt_file in txt_files:
    ...
    with open(txt_file, 'r') as file:
        ...
        # print(txt_file)
        log = os.path.basename(txt_file) + '50_ln.log'
        ...
        for i in range(ITE):
            ...
            workbook.save("Result\excel_result\Smith_50_test_ln_2.xlsx")
